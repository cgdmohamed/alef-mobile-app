                  ...
                  children: [
                    AppCard(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const StatusBadge(label: 'ممتاز', fg: AppColors.success, bg: AppColors.successBg),
                        ],
                      ),
                    ),
                    ...
                    Row(
                      children: const [
                        ...
                        SizedBox(width: 8),
                        Expanded(child: StatTile(value: '14', label: 'الواجبات', valueColor: AppColors.primary, valueSize: 15)),
                        SizedBox(width: 8),
                        Expanded(child: StatTile(value: '12', label: 'الإنجازات', valueColor: AppColors.warning, valueSize: 15)),
                      ],
                    ),
                    const SizedBox(height: 12),
                    AppCard(
